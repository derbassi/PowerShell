...
######################################################################################
#Do not forget to change the  $FolderPath  and the  $File  values:   lines-> 22 & 23 #
#                                     -----------           -----                    #
######################################################################################
...
Function GetMyeMails{
 ...
 $folder.items |
 Select-Object -Property Subject, Importance, ReceivedTime, SenderName, UnRead
